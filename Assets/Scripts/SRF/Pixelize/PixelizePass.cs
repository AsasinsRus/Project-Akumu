...
public class PixelizePass : ScriptableRenderPass
{
    ...
    private RTHandle _colorBuffer, _pixelBuffer;
    ...
    public PixelizePass(PixelizeFeature.CustomPassSettings settings)
    {
        ...
        RTHandleSystem rTHandleSystem = new RTHandleSystem();
        rTHandleSystem.Initialize(pixelScreenWidth, pixelScreenHeight);
    }
    ...
    public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
    {
        ...
        _pixelBuffer = RTHandles.Alloc(pixelBufferID);
    }
...
//            Blit(cmd, colorBuffer, pixelBuffer, material);
            Blit(cmd, _colorBuffer, _pixelBuffer, material);
//            Blit(cmd, pixelBuffer, colorBuffer);
